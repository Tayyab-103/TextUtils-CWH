...
export default function About(props) {
  ...
  // i don't need any more because button is removed
  // const toggleStyle = () => {
        ...
        <div class="accordion-item">
          ...
          >
            <div class="accordion-body" style={myStyle}>
              ...
              preparation of plain-text reports, e.g. for expanding and aligning
              strings that form the lines of such reports.
            </div>
          </div>
        </div>
      </div>
